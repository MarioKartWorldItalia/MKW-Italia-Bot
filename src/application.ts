        ...
        async function refreshChooseYourMemeMsg() {
            ...
            if (true) {
                ...
                for (const _role of cymRoles) {
                    ...
                    if (true)
                        rolesMembers.set(`${line}### ${bulletMk} ${await (await Application.getInstance().getMainGuild()).emojis.fetch(roleToEmoji.get(role.id))} **${role.name}** (${role.members.size})`, msg);
                    else
                ...
                const embed = new EmbedBuilder()
                    ...
                    .setImage("https://cdn.discordapp.com/attachments/1376213461251526797/1463167072480661684/GqD0yy0.png?ex=6970d806&is=696f8686&hm=550197289828bb3ac19b3da882b333d4d3257b4623131768a5a1f21c2fcde2d6&")
                    .toJSON();
                ...
                sendButtonsMsg(roles, channels[0]!, roleToEmoji);
            }
        }
